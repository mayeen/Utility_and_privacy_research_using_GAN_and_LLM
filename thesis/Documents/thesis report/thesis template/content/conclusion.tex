...
\section{Answers the Research Questions}
...
while removing its non-private counterpart's sole attribute-inference 
leak. In contrast, the differentially private GAN, PATE-GAN, 
collapses on both utility branches and earns only the apparent 
...
converts that moderate cost into a genuine privacy gain by removing the sole 
attribute-inference leak and driving outlier linkability to zero.The
