...
\begin{otherlanguage}{ngerman}
    ...
    Datenschutzregelungen wie der Health Insurance Portability and
    Accountability Act (HIPAA) und die Datenschutz-Grundverordnung (DSGVO)
    bilden den rechtlichen Rahmen, innerhalb dessen medizinische Daten
    verantwortungsvoll f\"ur die Forschung geteilt und weiterverwendet werden
    k\"onnen, w\"ahrend sich klassische Anonymisierungsverfahren gegen\"uber
    Angriffen durch Datenverkn\"upfung und Re-Identifikation wiederholt als
    ...
    Ohne formale Garantie bleibt die Wahl ein echter Zielkonflikt: HealthGAN
    erreicht die beste marginale Fidelit\"at und als einziger Generator ein
    N\"achste-Nachbarn-Distanzverh\"altnis am Referenzwert von eins. Die
