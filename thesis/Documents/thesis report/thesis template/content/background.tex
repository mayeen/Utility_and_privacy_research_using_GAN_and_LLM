...
(§\ref{sec:bg:dp}) used by the DP generators in this thesis. Unlike image 
...
statistical properties — a challenge that no single generative family solves cleanly, 
...
text~\cite{hernandez2022synthetic,Murtaza2023}. Each family admits a
differentially-private variant, yielding the GAN/LLM $\times$ DP/non-DP axes
along which the four generators evaluated in this thesis are positioned. The
